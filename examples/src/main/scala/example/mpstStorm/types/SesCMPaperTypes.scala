package example.mpstStorm.types
...
case class FailSupervisorSpawn(appId:Int,newAppID:Int) extends MSG {
   override def l : String = "FailSupervisorSpawn"
}
...
protected  object Hdl extends Hdl {
  override protected def __children: List[EPPSupervisor_W] = List(End_W_PSupervisor,SelFailSupervisorSpawnFailSupervisorEnd)
  override type implT = __HdlImp
...
protected  trait SelFailSupervisorSpawnFailSupervisorEnd extends EPPSupervisor_W with event_lang.dsl.ChannelTypeBrn
protected  object SelFailSupervisorSpawnFailSupervisorEnd extends SelFailSupervisorSpawnFailSupervisorEnd {
  override protected def __children: List[EPPSupervisor_W] = List(RcvFailSupervisorSpawn,RcvFailSupervisorEnd)
  override type implT = __SelFailSupervisorSpawnFailSupervisorEndImp
  override type implNextT = __RcvFailSupervisorSpawnImp
override def toString() : String = {"EPPSupervisor_W.SelFailSupervisorSpawnFailSupervisorEnd"}
  
  override protected def __create(c : AbstractChannel, session : Session) : implT = __SelFailSupervisorSpawnFailSupervisorEndImp(c,session)}

protected case class __SelFailSupervisorSpawnFailSupervisorEndImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  override def from : AbstractChannelType = {
    SelFailSupervisorSpawnFailSupervisorEnd
}
  // Branching is only a valid return type not a valid input type
}


  trait RcvFailSupervisorSpawn extends EPPSupervisor_W with event_lang.dsl.ChannelTypeRcv
  object RcvFailSupervisorSpawn extends RcvFailSupervisorSpawn {
  override protected def __children: List[EPPSupervisor_W] = List(SpawnPSupervisor)
  override type implT = __RcvFailSupervisorSpawnImp
  override type implNextT = __SpawnPSupervisorImp
override def toString() : String = {"EPPSupervisor_W.RcvFailSupervisorSpawn"}
  override type msgT = MESSAGES.PSupervisor.FailSupervisorSpawn
   override def frm : Role = Role("m",RoleSet("M")) 
   override def l : String = "FailSupervisorSpawn"
  override protected def __create(c : AbstractChannel, session : Session) : implT = __RcvFailSupervisorSpawnImp(c,session)}

protected case class __RcvFailSupervisorSpawnImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  override def from : AbstractChannelType = {
    RcvFailSupervisorSpawn
}
  def rcvFrmm_M : (MESSAGES.PSupervisor.FailSupervisorSpawn,__SpawnPSupervisorImp) = {(c.rcv(Role("m",RoleSet("M"))).asInstanceOf[MESSAGES.PSupervisor.FailSupervisorSpawn],__SpawnPSupervisorImp(c,session))}
def ?[T](f : PartialFunction[(MESSAGES.PSupervisor.FailSupervisorSpawn,__SpawnPSupervisorImp),T]) : T = {
  f((c.rcv(Role("m",RoleSet("M"))).asInstanceOf[MESSAGES.PSupervisor.FailSupervisorSpawn],__SpawnPSupervisorImp(c,session))) 
}
def rcvMSG : MESSAGES.PSupervisor.FailSupervisorSpawn = {c.rcv(Role("m",RoleSet("M"))).asInstanceOf[MESSAGES.PSupervisor.FailSupervisorSpawn]}
def ? : MESSAGES.PSupervisor.FailSupervisorSpawn = {c.rcv(Role("m",RoleSet("M"))).asInstanceOf[MESSAGES.PSupervisor.FailSupervisorSpawn]}
def channelCon : __SpawnPSupervisorImp = {__SpawnPSupervisorImp(c,session)}

}


  trait SpawnPSupervisor extends EPPSupervisor_W with event_lang.dsl.ChannelTypeSpawn
  object SpawnPSupervisor extends SpawnPSupervisor {
  override protected def __children: List[EPPSupervisor_W] = List(End_W_PSupervisorFailSupervisorSpawn_FHandling)
  override type implT = __SpawnPSupervisorImp
  override type implNextT = __End_W_PSupervisorFailSupervisorSpawn_FHandlingImp
override def toString() : String = {"EPPSupervisor_W.SpawnPSupervisor"}
...
protected  trait End_W_PSupervisorFailSupervisorSpawn_FHandling extends EPPSupervisor_W with event_lang.dsl.ChannelTypeEnd
protected  object End_W_PSupervisorFailSupervisorSpawn_FHandling extends End_W_PSupervisorFailSupervisorSpawn_FHandling {
  override protected def __children: List[EPPSupervisor_W] = List()
  override type implT = __End_W_PSupervisorFailSupervisorSpawn_FHandlingImp
  override type implNextT = Nothing
override def toString() : String = {"EPPSupervisor_W.End_W_PSupervisorFailSupervisorSpawn_FHandling"}
  
  override protected def __create(c : AbstractChannel, session : Session) : implT = __End_W_PSupervisorFailSupervisorSpawn_FHandlingImp(c,session)}

protected case class __End_W_PSupervisorFailSupervisorSpawn_FHandlingImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  override def from : AbstractChannelType = {
    End_W_PSupervisorFailSupervisorSpawn_FHandling
}
  ...
  override protected def __children: List[EPPSupervisor_W] = List(End_W_PSupervisorFailSupervisorEnd_FHandling)
  override type implT = __RcvFailSupervisorEndImp
  override type implNextT = __End_W_PSupervisorFailSupervisorEnd_FHandlingImp
...
protected case class __RcvFailSupervisorEndImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  ...
  def rcvFrmm_M : (MESSAGES.PSupervisor.FailSupervisorEnd,__End_W_PSupervisorFailSupervisorEnd_FHandlingImp) = {(c.rcv(Role("m",RoleSet("M"))).asInstanceOf[MESSAGES.PSupervisor.FailSupervisorEnd],__End_W_PSupervisorFailSupervisorEnd_FHandlingImp(c,session))}
def ?[T](f : PartialFunction[(MESSAGES.PSupervisor.FailSupervisorEnd,__End_W_PSupervisorFailSupervisorEnd_FHandlingImp),T]) : T = {
  f((c.rcv(Role("m",RoleSet("M"))).asInstanceOf[MESSAGES.PSupervisor.FailSupervisorEnd],__End_W_PSupervisorFailSupervisorEnd_FHandlingImp(c,session))) 
}
...
def channelCon : __End_W_PSupervisorFailSupervisorEnd_FHandlingImp = {__End_W_PSupervisorFailSupervisorEnd_FHandlingImp(c,session)}

}


protected  trait End_W_PSupervisorFailSupervisorEnd_FHandling extends EPPSupervisor_W with event_lang.dsl.ChannelTypeEnd
protected  object End_W_PSupervisorFailSupervisorEnd_FHandling extends End_W_PSupervisorFailSupervisorEnd_FHandling {
  override protected def __children: List[EPPSupervisor_W] = List()
  override type implT = __End_W_PSupervisorFailSupervisorEnd_FHandlingImp
  override type implNextT = Nothing
override def toString() : String = {"EPPSupervisor_W.End_W_PSupervisorFailSupervisorEnd_FHandling"}
  
  override protected def __create(c : AbstractChannel, session : Session) : implT = __End_W_PSupervisorFailSupervisorEnd_FHandlingImp(c,session)}

protected case class __End_W_PSupervisorFailSupervisorEnd_FHandlingImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  override def from : AbstractChannelType = {
    End_W_PSupervisorFailSupervisorEnd_FHandling
}
...
protected case class __End_m_M_PSupervisorImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  ...
  override protected def __children: List[EPPSupervisor_m_M] = List(SelFailSupervisorSpawnFailSupervisorEnd)
  override type implT = __Failed_w_WImp
  override type implNextT = __SelFailSupervisorSpawnFailSupervisorEndImp
...
protected case class __Failed_w_WImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  ...
  def failed_w_W(): __SelFailSupervisorSpawnFailSupervisorEndImp = {__SelFailSupervisorSpawnFailSupervisorEndImp(c,session)}

}


protected  trait SelFailSupervisorSpawnFailSupervisorEnd extends EPPSupervisor_m_M with event_lang.dsl.ChannelTypeSel
protected  object SelFailSupervisorSpawnFailSupervisorEnd extends SelFailSupervisorSpawnFailSupervisorEnd {
  override protected def __children: List[EPPSupervisor_m_M] = List(SndFailSupervisorSpawn,SndFailSupervisorEnd)
  override type implT = __SelFailSupervisorSpawnFailSupervisorEndImp
  override type implNextT = __SndFailSupervisorSpawnImp
override def toString() : String = {"EPPSupervisor_m_M.SelFailSupervisorSpawnFailSupervisorEnd"}
...
protected case class __SelFailSupervisorSpawnFailSupervisorEndImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  ...
  private var notUsed = true
def !(m : MESSAGES.PSupervisor.FailSupervisorSpawn) : __SpawnPSupervisorImp = {
assert(notUsed, s"The channel send musted be used linear")
 notUsed=false
c.snd(RoleSet("W"),m)
 __SpawnPSupervisorImp(c,session)}
def sndToW(m : MESSAGES.PSupervisor.FailSupervisorSpawn) : __SpawnPSupervisorImp = {
assert(notUsed, s"The channel send musted be used linear")
 notUsed=false
c.snd(RoleSet("W"),m)
 __SpawnPSupervisorImp(c,session)}

def !(m : MESSAGES.PSupervisor.FailSupervisorEnd) : __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp = {
assert(notUsed, s"The channel send musted be used linear")
 notUsed=false
c.snd(RoleSet("W"),m)
 __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp(c,session)}
def sndToW(m : MESSAGES.PSupervisor.FailSupervisorEnd) : __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp = {
assert(notUsed, s"The channel send musted be used linear")
 notUsed=false
c.snd(RoleSet("W"),m)
 __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp(c,session)}
  ...
  trait SndFailSupervisorSpawn extends EPPSupervisor_m_M with event_lang.dsl.ChannelTypeSnd
  object SndFailSupervisorSpawn extends SndFailSupervisorSpawn {
  override protected def __children: List[EPPSupervisor_m_M] = List(SpawnPSupervisor)
  override type implT = __SndFailSupervisorSpawnImp
  override type implNextT = __SpawnPSupervisorImp
override def toString() : String = {"EPPSupervisor_m_M.SndFailSupervisorSpawn"}
    override def to : RRole = RoleSet("W") 
   override def l : String = "FailSupervisorSpawn" 

  override protected def __create(c : AbstractChannel, session : Session) : implT = __SndFailSupervisorSpawnImp(c,session)}

protected case class __SndFailSupervisorSpawnImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  override def from : AbstractChannelType = {
    SndFailSupervisorSpawn
}
  private var notUsed = true
def sndToW(m : MESSAGES.PSupervisor.FailSupervisorSpawn) : __SpawnPSupervisorImp = {
assert(notUsed, s"The channel send musted be used linear")
...
c.snd(RoleSet("W"),m)
__SpawnPSupervisorImp(c,session)}
def snd(m : MESSAGES.PSupervisor.FailSupervisorSpawn) : __SpawnPSupervisorImp = {
assert(notUsed, s"The channel send musted be used linear")
 notUsed=false
c.snd(RoleSet("W"),m)
__SpawnPSupervisorImp(c,session)}
  ...
  trait SpawnPSupervisor extends EPPSupervisor_m_M with event_lang.dsl.ChannelTypeSpawn
  object SpawnPSupervisor extends SpawnPSupervisor {
  override protected def __children: List[EPPSupervisor_m_M] = List(End_m_M_PSupervisorFailSupervisorSpawn_FHandling)
  override type implT = __SpawnPSupervisorImp
  override type implNextT = __End_m_M_PSupervisorFailSupervisorSpawn_FHandlingImp
override def toString() : String = {"EPPSupervisor_m_M.SpawnPSupervisor"}
    override def y: List[Role] = List(Role("m",RoleSet("M"))) 
  override def pickR: RoleSet = RoleSet("W") 
  override def rs: List[RoleSet] = List(RoleSet("W")) 
  override def name: String = "PSupervisor" 
...
protected  trait End_m_M_PSupervisorFailSupervisorSpawn_FHandling extends EPPSupervisor_m_M with event_lang.dsl.ChannelTypeEnd
protected  object End_m_M_PSupervisorFailSupervisorSpawn_FHandling extends End_m_M_PSupervisorFailSupervisorSpawn_FHandling {
  override protected def __children: List[EPPSupervisor_m_M] = List()
  override type implT = __End_m_M_PSupervisorFailSupervisorSpawn_FHandlingImp
  override type implNextT = Nothing
override def toString() : String = {"EPPSupervisor_m_M.End_m_M_PSupervisorFailSupervisorSpawn_FHandling"}
  
  override protected def __create(c : AbstractChannel, session : Session) : implT = __End_m_M_PSupervisorFailSupervisorSpawn_FHandlingImp(c,session)}

protected case class __End_m_M_PSupervisorFailSupervisorSpawn_FHandlingImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  override def from : AbstractChannelType = {
    End_m_M_PSupervisorFailSupervisorSpawn_FHandling
}
  ...
  override protected def __children: List[EPPSupervisor_m_M] = List(End_m_M_PSupervisorFailSupervisorEnd_FHandling)
  override type implT = __SndFailSupervisorEndImp
  override type implNextT = __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp
...
c.snd(RoleSet("W"),m)
__End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp(c,session)}
def snd(m : MESSAGES.PSupervisor.FailSupervisorEnd) : __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp = {
assert(notUsed, s"The channel send musted be used linear")
 notUsed=false
c.snd(RoleSet("W"),m)
__End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp(c,session)}
...
protected  trait End_m_M_PSupervisorFailSupervisorEnd_FHandling extends EPPSupervisor_m_M with event_lang.dsl.ChannelTypeEnd
protected  object End_m_M_PSupervisorFailSupervisorEnd_FHandling extends End_m_M_PSupervisorFailSupervisorEnd_FHandling {
  override protected def __children: List[EPPSupervisor_m_M] = List()
  override type implT = __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp
  override type implNextT = Nothing
override def toString() : String = {"EPPSupervisor_m_M.End_m_M_PSupervisorFailSupervisorEnd_FHandling"}
  
  override protected def __create(c : AbstractChannel, session : Session) : implT = __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp(c,session)}

protected case class __End_m_M_PSupervisorFailSupervisorEnd_FHandlingImp(private val c : AbstractChannel, session : Session) extends AbstractChannelImp {
  override def from : AbstractChannelType = {
    End_m_M_PSupervisorFailSupervisorEnd_FHandling
}
